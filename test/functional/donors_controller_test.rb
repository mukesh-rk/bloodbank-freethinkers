...
class DonorsControllerTest < ActionController::TestCase
  ...
  test "should create donor" do
    assert_difference('Donor.count') do
      post :create, donor: { blood_group_id: @donor.blood_group_id, contact: @donor.contact, email: @donor.email, name: @donor.name }
    end
  ...
  test "should update donor" do
    put :update, id: @donor, donor: { blood_group_id: @donor.blood_group_id, contact: @donor.contact, email: @donor.email, name: @donor.name }
    assert_redirected_to donor_path(assigns(:donor))
  end
